      ...
      <section className="container section">
        ...
        <div className="contact-grid" style={{ marginTop: 26 }}>
          <div className="contact-card">
            ...
            <p className="lead">{contact.orderInstructions || t("contactCardBody")}</p>
          ...
          <div className="contact-card">
            ...
            <ul className="option-list">
              ...
              <li><span>{t("pickupLabel")}</span><strong>{contact.pickupArea}</strong></li>
              <li><span>{t("businessHoursLabel")}</span><strong>{contact.businessHours}</strong></li>
            </ul>
